...
EngagedNation.RequireJS.define(
    ...
    function($, LbxGrid)
    {
         ...
         */
        var Rampart10kLbxGrid = function(config)
        {
            this.config = {
         ...
         * Add methods
         */
        Rampart10kLbxGrid.prototype = $.extend(
        ...
        {
            EngagedNation.jQuery.extensions.Rampart10kLbxGrid = new Rampart10kLbxGrid(config);
        };
