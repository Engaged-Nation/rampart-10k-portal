/**
 * Rampart10k version of lbxtooltip
 *
...
EngagedNation.RequireJS.define(
    ...
    function($, LbxToolTip)
    {
         ...
         */
        var Rampart10kLbxToolTip = function(config)
        {
         ...
         * Add methods
         */
        Rampart10kLbxToolTip.prototype = $.extend(
        ...
        {
            EngagedNation.jQuery.extensions.Rampart10kLbxToolTip = new Rampart10kLbxToolTip(config);
        };

        return Rampart10kLbxToolTip;
    }
);
